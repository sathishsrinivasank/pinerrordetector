#' Variation-2
#'
#' Inner loop of neighborful algorithm used by its variations B and F
#'
...
#'
#' @return A vector of excluded colonies by variation2
#'
#' @examples
#' plateformat <- 1536
#' middle_colony <- 34
...
#' variation2(colony = middle_colony,
                       ...
                       param2_threshold)
{
  for(combin_coords_index in 1:ncol(combin_coords)){
    ...
    # 3. Apply parameter 2
    excluded_colonies_param2 <- parameter2(colony = colony,
                                           combinations = combinations,
                                           excluded_colonies = excluded_colonies,
                                           param2_threshold = param2_threshold)
