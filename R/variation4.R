# Variation: 4
# variation4(colony, combin_coords, neighbors_selected_colony, excluded_colonies, colony_area_raw_data, plate_median_threshold, neighbor_length_threshold, parameter1)
