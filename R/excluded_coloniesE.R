#' Neighborful algorithm - Variation-E
#'
#' The variation-E of neighborful algorithm uses both \code{param1_threshold} and
#' \code{param2_threshold} exclusion criteria to remove colonies as excluded ones
#' by removing \code{empty_indices} from both outer and inner loops of the
...
#' excluded by the previous iteration of neighborful algorithm of variation-E.
...
#'                    param2_threshold = 1,
#'                    is_middle = TRUE)
excluded_coloniesE <- function(plateformat,
                               colony_indices,
