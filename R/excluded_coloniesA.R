#' Neighborful algorithm - Variation-A
#'
#' The variation-A of neighborful algorithm uses both \code{param1_threshold} and
#' \code{param2_threshold} exclusion criteria to remove colonies as excluded ones
#' by not removing \code{empty_indices} from outer loop and by removing
...
#' excluded by the previous iteration of neighborful algorithm. of variation-A.
...
#'
#' @return The numeric vector of excluded colony indices by neighborful algorithm
#'  of variation-A
#' @export
#'
#' @examples
...
#'                    is_middle = TRUE)
#'
excluded_coloniesA <- function(plateformat,
                               colony_indices,
