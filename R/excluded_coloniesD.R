#' Neighborful algorithm - Variation-D
#'
#' The variation-D of neighborful algorithm uses only \code{param1_threshold}
#' exclusion criterion to remove colonies as excluded ones by not removing
#' \code{empty_indices} from outer loop and by removing \code{empty_indices}
...
#'                    param1_threshold = 1,
#'                    is_middle = TRUE)
excluded_coloniesD <- function(plateformat,
                               colony_indices,
